...
search.addEventListener('click', ()=>{
    ...
    fetch(url).then(response => response.json()).then(json => {
        ...
        switch (json.weather[0].main) {
            case 'Clear':
                image.src = '../../Clima js/img/clear.png';
                break;

            case 'Rain':
                image.src = '../../Clima js/img/rain.png';
                break;

            case 'Snow':
                image.src = '../../Clima js/img/snow.png';
                break;

            case 'Clouds':
                image.src = '../../Clima js/img/cloud.png';
                break;

            case 'Haze':
                image.src = '../../Clima js/img/mist.png';
                break;
